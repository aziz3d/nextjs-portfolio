  ...
  useEffect(() => {
    ...
    try {
      ...
      if (storedContent) {
        ...
        setContent(parsedContent.privacyPolicy)
        
        // Extract last updated date from content if available
        const lastUpdatedMatch = parsedContent.privacyPolicy.match(/Last updated: ([^\n]*)/)
        ...
        >
          {content ? (
            ...
            <div className="text-center py-8">
              <p className="text-gray-500 dark:text-gray-400">Privacy policy content is being loaded...</p>
            </div>
          )}
